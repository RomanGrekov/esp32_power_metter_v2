...
typedef enum Key_Pressed {
 ...
 typedef const struct Menu_Item {
  ...
  void (*SelectCallback)(int); /**< Pointer to the optional menu-specific select callback of this menu item */
  void (*EnterCallback)(Key_Pressed_t); /**< Pointer to the optional menu-specific enter callback of this menu item */
  ...
  */
 #define MENU_ITEM(Name, Next, Previous, Parent, Child, SelectFunc, EnterFunc, Text, Index) \
  ...
  Menu_Item_t const Name = {&Next, &Previous, &Parent, &Child, SelectFunc , EnterFunc, Text, Index}
